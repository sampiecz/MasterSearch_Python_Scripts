...
CLIENT_ID = 'Need special client ID'
CLIENT_SECRET = 'Need special client SECRET'
...
for item in list_files(drive_service):
    ...
    download_url = None
    if 'exportLinks' in item and 'application/zip' in item['exportLinks']:
        download_url = item['exportLinks']['application/zip']
